...
ALTER TABLE "public"."_schema_version" OWNER TO "postgres";
...
INSERT INTO "public"."_schema_version" ("version") VALUES
	('04-remove-password');
...
ALTER TABLE ONLY "public"."_schema_version"
    ADD CONSTRAINT "_schema_version_pkey" PRIMARY KEY ("version");
